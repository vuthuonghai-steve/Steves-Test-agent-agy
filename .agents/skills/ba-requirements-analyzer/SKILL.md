...
| :--- | :--- | :--- |
| **Bóc tách danh sách yêu cầu thô, phỏng vấn stakeholder** | [`knowledge/babok-requirements-taxonomy.md`](file:///c:/Users/ADMIN/Documents/workspace/Steves/.agents/skills/ba-requirements-analyzer/knowledge/babok-requirements-taxonomy.md) + [`templates/requirements-classification.template.md`](file:///c:/Users/ADMIN/Documents/workspace/Steves/.agents/skills/ba-requirements-analyzer/templates/requirements-classification.template.md) | Bảng phân loại chuẩn 4 tầng (BR, SR, FR, NFR, TR) |
| **Xử lý yêu cầu phi chức năng (tốc độ, tải, bảo mật, SLA)** | [`knowledge/nfr-quantification-guide.md`](file:///c:/Users/ADMIN/Documents/workspace/Steves/.agents/skills/ba-requirements-analyzer/knowledge/nfr-quantification-guide.md) | Bảng NFR định lượng SMART (p95 latency, concurrency, uptime SLA, Idempotency) |
| **Lập kế hoạch chuyển đổi, chuẩn bị Go-Live** | [`knowledge/transition-requirements-radar.md`](file:///c:/Users/ADMIN/Documents/workspace/Steves/.agents/skills/ba-requirements-analyzer/knowledge/transition-requirements-radar.md) | Kế hoạch Transition Matrix (Data Migration, Training nhân sự, Cutover & Rollback) |
| **Kiểm tra độ phủ tính năng, rà soát tính năng thừa/thiếu** | [`knowledge/traceability-and-anti-patterns.md`](file:///c:/Users/ADMIN/Documents/workspace/Steves/.agents/skills/ba-requirements-analyzer/knowledge/traceability-and-anti-patterns.md) + [`templates/rtm-traceability-matrix.template.md`](file:///c:/Users/ADMIN/Documents/workspace/Steves/.agents/skills/ba-requirements-analyzer/templates/rtm-traceability-matrix.template.md) | Bảng Ma trận truy vết 2 chiều RTM kèm báo cáo cảnh báo Gold-plating & Orphaned Goals |
| **Chuyển hóa yêu cầu thành User Stories cho Dev & QA** | [`templates/user-story-ac.template.md`](file:///c:/Users/ADMIN/Documents/workspace/Steves/.agents/skills/ba-requirements-analyzer/templates/user-story-ac.template.md) | Bộ User Story chuẩn hóa kèm Acceptance Criteria (Gherkin) và ràng buộc NFR |
| **Thẩm định chất lượng tài liệu trước khi bàn giao** | [`loop/ba-requirements-checklist.md`](file:///c:/Users/ADMIN/Documents/workspace/Steves/.agents/skills/ba-requirements-analyzer/loop/ba-requirements-checklist.md) + [`schemas/ba-audit-schema.json`](file:///c:/Users/ADMIN/Documents/workspace/Steves/.agents/skills/ba-requirements-analyzer/schemas/ba-audit-schema.json) | Kết quả kiểm định cơ học đạt chuẩn APPROVED (Exit code 0) |
